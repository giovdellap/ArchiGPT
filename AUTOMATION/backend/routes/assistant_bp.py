...
from controllers.AssistantController import create_assistant

assistant_bp = Blueprint('assistant_bp', __name__)

#assistant_bp.route('/', methods=['GET'])(get_all_assistants)
assistant_bp.route('/create', methods=['POST'])(create_assistant)
