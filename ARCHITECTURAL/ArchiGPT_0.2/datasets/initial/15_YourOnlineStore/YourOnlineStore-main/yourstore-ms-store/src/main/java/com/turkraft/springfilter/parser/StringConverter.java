...
public class StringConverter {
	...
	public static Object convert(String input, Class<?> expectedType) {
		...
		try {
			Method m = expectedType.getDeclaredMethod("setObjectKey", String.class);
			Object instance = expectedType.getConstructor().newInstance();
	...
	public static boolean isSupportedAsInput(Object input) {
		return input instanceof Boolean || input instanceof Number || input instanceof Character
				...
				|| input instanceof LocalDateTime || input instanceof OffsetDateTime || input instanceof LocalTime
